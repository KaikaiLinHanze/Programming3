...
Date : 2022.06.10
Description :
To get the N50 from each contigs.fa file.
Output a csv file.
Get the best result to this folder.
"""
import pandas as pd
...
def get_N50():
    ...
    for i in range (19,32,2):
        try:
            fasta_sequences = SeqIO.parse(open(f"/students/2021-2022/master/Kai_DSLS/output/{i}/contigs.fa"),'fasta')
...
def get_the_best_file():
    ...
    src_path = f"/students/2021-2022/master/Kai_DSLS/output/{contif}/contigs.fa"
    dst_path = f"output"
