...
def random_forest_model(trainData,testData):
    """
    it will help you to make a random forest model.
    trainData: spark df
    testData: spark df
    return model
    """
...
def tuning_random_forest_model(trainData,testData):
    """
    ...
    print(rf_evaluator.evaluate(rf_cvPredictions))
    return rf_cvModel
